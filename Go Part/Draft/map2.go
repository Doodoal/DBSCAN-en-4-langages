   ...
   */
   ...
   for _,point:= range coords{
    ...
    for _,pointN:= range neighbors{
      clusterLabel(pointN , label,coords, MinPts, eps)
     }
...
func clusterLabel(point LabelledGPScoord, label int, coords []LabelledGPScoord, MinPts int, eps float64){
