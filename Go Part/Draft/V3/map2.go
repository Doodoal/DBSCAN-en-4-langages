   ...
   */
   ...
   for _,point:= range coords{
    ...
    for _,neighbor:= range neighbors{
      seedSet(neighbor, label, coords, eps, MinPts)
     }
...
func seedSet(neighbor LabelledGPScoord,label int,coords []LabelledGPScoord,eps float64, MinPts int){
