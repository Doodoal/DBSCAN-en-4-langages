   ...
   */
   ...
   for _,point:= range coords{
    ...
    for _,neighbor:= range neighbors{
      extands(neighbor,label, coords, MinPts, eps)
     }
...
/*
clusterLabel labelise tous les LabelledGPScoord du cluster auquel point appartient
*/
func extands (point LabelledGPScoord,label int, coords []LabelledGPScoord,MinPts int, eps float64){
neighbors := rangeQuery( point,coords, eps)
